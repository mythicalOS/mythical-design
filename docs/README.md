...
## Where this repository's documentation lives today

This directory is new and currently holds only this page. The reference material that ships with
the package lives at the repository root:

| File | What it covers |
|------|----------------|
| `README.md` | What the package is, how to install it, what it ships, theming, and the review rules. |
| `design.md` | The design book: direction, brand, colour tokens, typography, shape/space/motion, app shell, and components and interaction rules. |
| `COMPONENTS.md` | One row per component — spec version, whether it ships from a package or is built in one product, and the implementation it maps to. |
| `CHANGELOG.md` | Released versions and what changed in each. |

Community-health and policy files — `CONTRIBUTING.md`, `SECURITY.md`, `CODE_OF_CONDUCT.md`,
`SUPPORT.md`, `LICENSE`, `NOTICE`, `TRADEMARK.md` — are at the repository root as well.
